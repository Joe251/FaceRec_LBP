...
Ptr<FaceRecognizer> learnCollectedFaces(const vector<Mat> preprocessedFaces, const vector<int> faceLabels, const string facerecAlgorithm, Ptr<FaceRecognizer> model)
{
	...
	if (_file)
	{
		//model->load(preprocessedFaces, faceLabels);
